          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                rows={14}
                className="w-full rounded-lg border border-abyss-700 bg-abyss-950/70 px-4 py-3 text-sm leading-6 text-azure-50 outline-none transition placeholder:text-muted-foreground focus:border-azure-500/60"
              />
            </div>
          </div>
