            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={24}
                  className="min-h-[560px] w-full resize-y rounded-lg border border-abyss-700 bg-abyss-950/70 px-4 py-3 text-sm leading-7 text-azure-50 outline-none transition focus:border-azure-500/60"
                />
