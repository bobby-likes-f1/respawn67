...
const MOCK_GAMES_DB: Record<string, any> = {
  "1": {
    ...
    bannerImage: "https://images.igdb.com/igdb/image/upload/t_1080p_2x/sccj5r.webp",
    posterImage: "https://images.igdb.com/igdb/image/upload/t_1080p/co1x7d.webp",
  ...
  "2": {
    ...
    year: "2024",
    tagline: "FREEDOM DOESN'T COME FREE.",
    ...
    bannerImage: "https://images.igdb.com/igdb/image/upload/t_1080p_2x/sccj5r.webp", // Mock fallback header
    posterImage: "https://images.igdb.com/igdb/image/upload/t_1080p/co7qvq.webp",
    genres: ["SHOOTER", "CO-OP", "ACTION"],
    platforms: ["PC", "PS5"],
    stats: { views: "1.2M", lists: "400K", likes: "890K" }
  }
};
           ...
           <div className="bg-abyss-900 border border-abyss-800 rounded-xl overflow-hidden shadow-[0_10px_40px_-10px_rgba(0,0,0,0.8)] sticky top-24 ring-1 ring-white/5 transition-all">
             ...
             <div className="grid grid-cols-3 bg-abyss-950/60 divide-x divide-abyss-800/60">
               ...
               >
                 ...
                 <span className={`text-[9.5px] uppercase font-bold tracking-wider transition-colors ${isReviewed ? 'text-azure-400' : 'text-muted-foreground group-hover:text-azure-400'}`}>Reviewed</span>
               </div>
               <div 
               ...
               >
                 ...
                 <span className={`text-[9.5px] uppercase font-bold tracking-wider transition-colors ${isLiked ? 'text-azure-400' : 'text-muted-foreground group-hover:text-azure-400'}`}>Like</span>
               </div>
               <div 
               ...
               >
                 ...
                 <span className={`text-[9.5px] uppercase font-bold tracking-wider transition-colors ${inPlaylist ? 'text-azure-400' : 'text-muted-foreground group-hover:text-azure-400'}`}>Playlist</span>
               </div>
             </div>
             ...
             <div className="px-4 py-6 border-t border-abyss-800/60 flex flex-col items-center gap-3 bg-abyss-900/60 backdrop-blur-sm shadow-inner group/rater">
               ...
               >
                  {[1,2,3,4,5].map(index => {
                     ...
                     const isActive = currentScore >= valLeft;
                     ...
                     return (
                       <div key={index} className="relative w-9 h-9 sm:w-10 sm:h-10 cursor-pointer hover:scale-110 transition-transform duration-200">
                         ...
                         <div 
                           ...
                           onClick={() => setRating(rating === valLeft ? 0 : valLeft)}
                         />
                         <div 
                           className="absolute top-0 right-0 w-1/2 h-full z-10" 
                           onMouseEnter={() => setHoverRating(valRight)}
                           onClick={() => setRating(rating === valRight ? 0 : valRight)}
                         />
                       </div>
                     );
                  })}
             ...
             <div className="flex flex-col text-[13px] font-semibold bg-abyss-900/60 divide-y divide-abyss-800/60 mt-0.5">
                <div className="py-3.5 px-4 text-center text-muted-foreground/80 hover:bg-abyss-800/80 hover:text-white transition-colors cursor-pointer border-t border-abyss-800/60">
                  Review or log again...
                </div>
                <div className="py-3.5 px-4 text-center text-muted-foreground/80 hover:bg-abyss-800/80 hover:text-white transition-colors cursor-pointer">
                  Add to lists...
                </div>
                <div className="py-3.5 px-4 text-center text-muted-foreground/80 hover:bg-abyss-800/80 hover:text-white transition-colors cursor-pointer bg-abyss-950/20">
                  Share
                </div>
             </div>
           </div>
